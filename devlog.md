...
| 編號 | 行號 | 日期時間 | 問題摘要 |
| --- | --- | --- | --- |
| 001 | L96 | 2026-04-21 11:24:55 | 建立 devlog 紀錄準則 |
| 002 | L102 | 2026-04-21 12:01:29 | 建立 VS Code Debug 與 Live Watch 設定 |
| 003 | L107 | 2026-04-21 12:47:38 | 修正 VS Code tasks 的 CMake 路徑依賴 |
| 004 | L112 | 2026-04-21 12:53:23 | 補齊 CMake preset 的 Ninja 路徑 |
| 005 | L117 | 2026-04-21 12:55:30 | 讓 toolchain 自動尋找 Arm GCC |
| 006 | L122 | 2026-04-21 12:56:11 | 修正 CMake 對 ProgramFiles(x86) 的解析 |
| 007 | L127 | 2026-04-21 12:56:53 | 補上 Windows 工具鏈執行檔副檔名 |
| 008 | L132 | 2026-04-21 13:31:19 | 補齊 Cortex-Debug 的 GDB 路徑設定 |
| 009 | L137 | 2026-04-21 15:16:52 | 新增 OpenOCD Live Watch 啟動設定 |
| 010 | L142 | 2026-04-21 17:06:31 | 改為 under-reset 連線模式以穩定 halt target |
| 011 | L147 | 2026-04-21 19:32:13 | 降低 debug 接管頻率以改善 reset 後 halt |
| 012 | L152 | 2026-04-21 19:55:49 | 對齊 G431 專案的 pinned-probe 與 attach 設定 |
| 013 | L157 | 2026-04-21 20:23:58 | 修正 STM32N6 的 ST-LINK 核心 AP 選擇 |
| 014 | L162 | 2026-04-21 20:36:50 | 改用 Appli RAM image 啟動流程以停在 main |
| 015 | L167 | 2026-04-21 21:33:53 | 改由 Cortex-Debug 接手停在 main 與 Pause 中斷 |
| 016 | L172 | 2026-04-21 21:38:52 | 整理 STM32N6 Debug 避坑排查順序 |
| 017 | L177 | 2026-04-21 21:46:52 | 完成 Phase 0 的 UART log、LED blink 與 Button input |
| 018 | L182 | 2026-04-22 06:56:19 | 將 Phase 0 自訂修改搬回 USER CODE 區塊避免被 CubeMX 覆蓋 |
| 019 | L187 | 2026-04-22 12:24:14 | 補上 Appli RAM image 的 Reset 與 Restart 重載流程 |
| 020 | L192 | 2026-04-22 20:24:44 | 補上 Appli Phase 1 的 I2C1 bring-up 與掃描 |
| 021 | L197 | 2026-04-22 20:30:36 | 將 I2C HAL 開關移到 CMake 以避開 CubeMX 覆蓋 |
| 022 | L202 | 2026-04-23 14:39:09 | 新增 Phase 1 感測器辨識以驗證 MPU6050 與 VL53L0X 接線 |
| 023 | L207 | 2026-04-23 14:53:23 | 補上 Phase 1 感測器讀值與修正按鍵極性 |
| 024 | L212 | 2026-04-23 15:04:20 | 強化 Phase 1 telemetry 以判讀 MPU6050 與 VL53L0X 量測品質 |
| 025 | L217 | 2026-04-23 15:11:08 | 修正 VL53L0X raw status 11 的判讀避免誤報異常 |
| 026 | L222 | 2026-04-23 15:52:04 | 抽離應用層模組以避免 CubeMX 生成覆蓋 |
| 027 | L227 | 2026-04-23 15:58:42 | 補上 CubeMX 生成後遺漏的 TIM 共用時脈設定呼叫 |
| 028 | L232 | 2026-04-23 16:03:33 | 新增 TIM1 CH1 舵機安全起始與按鈕切換控制 |
| 029 | L237 | 2026-04-23 16:16:21 | 依實際 TIMG 時脈校正舵機 PWM 週期與脈寬 |
| 030 | L242 | 2026-04-23 16:24:59 | 放大舵機開合脈寬到 1100 與 1900 us |
| 031 | L247 | 2026-04-23 18:55:26 | 切換到舵機安裝中位模式固定 1500 us |
| 032 | L252 | 2026-04-24 08:10:34 | 新增舵機安全步進量測模式以找出夾爪可用範圍 |
| 033 | L257 | 2026-04-24 08:22:55 | 依實測結果收斂舵機量測窗到 700..1600 us |
| 034 | L262 | 2026-04-24 08:28:04 | 改成按鍵觸發的鬆夾鬆正式動作模式 |
| 035 | L267 | 2026-04-24 08:50:53 | 改成按一下夾住再按一下放開的切換式動作 |
| 036 | L272 | 2026-04-24 08:58:31 | 初始化 Git 並推送到 GitHub 遠端但排除 devlog |
| 037 | L277 | 2026-04-24 09:21:18 | 啟用第二顆舵機 CH2 並固定中位做安全 bring-up |
| 038 | L282 | 2026-04-24 10:25:06 | 暫時把按鍵改成只量 CH2 範圍並固定夾爪不動 |
| 039 | L287 | 2026-04-24 10:45:58 | 將 CH2 量測下限由 1200 放寬到 900 us |
| 040 | L292 | 2026-04-24 10:50:02 | 將 CH2 定成 900 與 1800 的正式前後切換模式 |
| 041 | L297 | 2026-04-24 11:31:23 | 檢查 regenerate 並接入第三顆舵機 CH3 安全量測模式 |
| 042 | L302 | 2026-04-24 12:01:55 | 將第三顆舵機 CH3 量測下限由 1300 放寬到 1000 us |
| 043 | L307 | 2026-04-24 12:04:28 | 將第三顆舵機 CH3 量測上限由 1700 放寬到 1900 us |
| 044 | L312 | 2026-04-24 12:08:05 | 將第三顆舵機 CH3 定成 1000 與 1500 的正式上下切換模式 |
| 045 | L317 | 2026-04-24 12:12:43 | 將舵機命名改成 clamp、fore_aft、gripper_lift 語意 |
| 046 | L322 | 2026-04-24 12:23:22 | 檢查第四顆舵機 regenerate 並接入 CH4 安全量測模式 |
| 047 | L327 | 2026-04-24 14:01:21 | 將第四顆舵機 CH4 量測窗由 1300..1700 放寬到 1000..1900 us |
| 048 | L332 | 2026-04-24 14:04:52 | 將第四顆舵機 CH4 量測窗由 1000..1900 放寬到 700..2300 us |
| 049 | L337 | 2026-04-24 14:35:06 | 將第四顆舵機 CH4 定成 2000 左與 1000 右的正式切換模式 |
| 050 | L342 | 2026-04-24 14:40:37 | 將第四顆舵機命名由 axis4 改成 left_right 語意 |
| 051 | L347 | 2026-04-24 15:07:09 | 補強 VL53L0X single-shot 失敗點診斷 |
| 052 | L352 | 2026-04-24 15:18:07 | 將按鍵改成觸發 4 軸全範圍展示模式 |
| 053 | L357 | 2026-04-24 15:26:06 | 將 left_right 軸移到展示序列最前面 |
| 054 | L362 | 2026-04-24 15:38:53 | 建立機械手臂空間座標、雅各比矩陣與逆運動學模組 |
| 055 | L367 | 2026-04-24 16:05:00 | 將實測不撞範圍升級為工作空間估算硬限制 |
| 056 | L372 | 2026-04-24 20:16:47 | 將實測安全範圍接入舵機實際控制路徑 |
| 057 | L377 | 2026-04-24 20:36:40 | 建立 UART XYZ/PWM 控制鏈與桌面 GUI debug 工具 |
| 058 | L382 | 2026-04-24 20:46:26 | 為 GUI 加入對應動作的機械手臂動態視覺預覽 |
| 059 | L387 | 2026-04-24 20:51:32 | 為 GUI 加入右側與下側捲軸避免小視窗截斷 |
| 060 | L392 | 2026-04-24 20:55:46 | 修正 GUI 最小尺寸與預覽雷達面板的裁切 |
| 061 | L397 | 2026-04-24 21:14:05 | 將預覽圖例移到下方並收斂預覽字級與間距 |
| 062 | L402 | 2026-04-24 21:21:04 | 依視窗寬度自動重排控制區避免右側預覽被壓扁 |
| 063 | L407 | 2026-04-24 21:58:50 | 將 4 軸舵機控制改成多軸同步 minimum-jerk 軌跡引擎 |
| 064 | L412 | 2026-04-24 22:13:52 | 將 XYZ 升級成 Cartesian minimum-jerk 路徑規劃 |
| 065 | L417 | 2026-04-24 22:13:52 | 讓 GUI 接上 firmware 軌跡狀態並自動輪詢 STATUS |
| 066 | L422 | 2026-04-25 07:46:52 | 在 GUI 標示 XYZ 的 conservative 可輸入範圍 |
| 067 | L427 | 2026-04-25 07:51:28 | 讓超界 XYZ 欄位變紅並在送出前硬擋 |
| 068 | L432 | 2026-04-25 07:57:00 | 修正 GUI 顯示 Send 被擋下的即時原因 |
| 069 | L437 | 2026-04-25 08:03:49 | 在 GUI 顯示 PWM/HOME/XYZ 的 FW 命令回覆與 echo |
| 070 | L442 | 2026-04-25 08:12:32 | 將 UART 命令接收改成 IRQ ring buffer 以修正多次設定後失聯 |
| 071 | L447 | 2026-04-25 11:43:00 | 將 GUI 起始手臂圖改成檯燈式展示姿態 |
| 072 | L452 | 2026-04-25 11:49:52 | 將 GUI 預設值改成區間中點並放大預覽下壓範圍 |
| 073 | L457 | 2026-04-25 11:59:29 | 對齊 HOME 與 Load Midpoint 的中點姿態 |
| 074 | L462 | 2026-04-25 12:05:01 | 恢復 GUI 啟動時的檯燈式展示姿態 |
| 075 | L467 | 2026-04-25 12:11:04 | 將 GUI 平台移到最低手臂點下方 |
| 076 | L472 | 2026-04-25 12:20:00 | 將 GUI 預覽改成工業臂外觀並標示關節語意 |
| 077 | L477 | 2026-04-25 12:33:52 | 將 GUI 底座改成較低的 pedestal 與斜撐 |
| 078 | L482 | 2026-04-25 12:46:35 | 將 GUI 中使用者圈選的區段再縮短 |
| 079 | L487 | 2026-04-25 13:03:55 | 將 GUI 黃橘色上臂改成反 2 反摺造型 |
| 080 | L492 | 2026-04-25 13:08:35 | 依參考照片重構 GUI side view 構圖 |
| 081 | L497 | 2026-04-25 13:13:59 | 壓低 GUI 底座並將肩段改成先垂直再水平 |
| 082 | L502 | 2026-04-25 13:18:17 | 將黃色直桿縮到最短並移除橘色上段 |
| 083 | L507 | 2026-04-25 13:21:52 | 修正第一個關節必須與底座實際連接 |
| 084 | L512 | 2026-04-25 13:24:08 | 將第一個關節改成直接坐在底座上 |
| 085 | L517 | 2026-04-25 13:32:23 | 修正 fore 關節只應轉角且擴展置中 side view |
| 086 | L522 | 2026-04-25 13:32:23 | 修正 side view bounds 導致只剩關節的壓縮問題 |
| 087 | L528 | 2026-04-25 13:58:08 | 將 fore 角度範圍改為 30..90 並再壓低底座台 |
| 088 | L534 | 2026-04-25 14:10:46 | 讓 Motion Preview 內容依實際畫布寬度置中 |
| 089 | L544 | 2026-04-25 14:15:06 | 修正首次開啟 GUI 時 preview 尚未置中 |
| 090 | L549 | 2026-04-25 17:14:32 | 新增可點擊的 3D workspace 雲圖與點選移動 |
| 091 | L554 | 2026-04-25 17:24:20 | 將 3D workspace 升級為 hover、旋轉與按住預覽放開送出 |
| 092 | L559 | 2026-04-26 10:01:06 | 放大 3D workspace 點雲並提高整片區域可點性 |
| 093 | L564 | 2026-04-26 10:09:42 | 將 3D workspace 預設改成前視第一人稱投影 |
| 094 | L570 | 2026-04-26 11:56:54 | 新增 Live Follow 模式與可調反應時間欄位 |
| 095 | L576 | 2026-04-26 12:04:53 | 將 devlog.md 正式納入 Git 版本控制 |
